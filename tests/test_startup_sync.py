...
class TestStartupSync:
    ...
    def test_ensure_startup_sync_skips_when_job_running(
        self, mock_settings, mock_last_success, mock_has_running_job
    ):
    ...
    def test_ensure_startup_sync_skips_no_credentials(
        ...
        mock_settings.return_value = Mock(arkmeds_email=None, arkmeds_password=None)
    ...
    def test_ensure_startup_sync_starts_thread(
        self, mock_logger, mock_thread, mock_settings, mock_last_success, mock_has_running_job
    ):
        ...
        mock_settings.return_value = Mock(
            arkmeds_email="test@test.com", arkmeds_password="password123"
        )
...
class TestStartupSyncStatus:
    ...
    def test_get_startup_sync_status_running(self, mock_has_running_job):
        ...
        # Arrange
        running_job = {"job_id": "delta-123", "status": "running", "processed": 50, "total": 100}
    ...
    @patch("app.core.startup.has_running_job")
    @patch("app.core.startup.get_last_success_job")
    def test_get_startup_sync_status_completed(self, mock_last_success, mock_has_running_job):
    ...
    @patch("app.core.startup.has_running_job")
    @patch("app.core.startup.get_last_success_job")
    def test_get_startup_sync_status_none(self, mock_last_success, mock_has_running_job):
...
class TestCacheResource:
    ...
    def test_ensure_startup_sync_executes_once(
        self, mock_thread, mock_settings, mock_has_running_job
    ):
