...
from ..core.constants import OSType
...
class DataValidator:
    ...
    def validate_date_column(
        ...
        try:
            ...
            raise DataValidationError(f"Failed to validate date column '{column}': {e!s}")
    ...
    def validate_pydantic_model(
        ...
        try:
            ...
            raise DataValidationError(f"Pydantic validation failed: {e!s}")
...
class DataTransformer:
    ...
    def calculate_duration_hours(
        ...
        try:
            ...
            logger.warning(f"Failed to calculate duration: {e!s}")
            return None
    ...
    def aggregate_by_period(
        ...
        try:
            ...
            logger.error(f"Failed to aggregate data by period: {e!s}")
            return pd.DataFrame()
